...
STAGE_BY_NODE: dict[str, Stage] = {
    ...
    "figure_planner": "generating_report",
    "chart_generator": "generating_report",
    "diagram_generator": "generating_report",
    "illustration_planner": "generating_report",
    "image_generator": "generating_report",
    "web_image_fetcher": "generating_report",
